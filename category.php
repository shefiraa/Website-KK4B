                ...
                <table border="1" cellspacing="0" class="tabel">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-category.php?id=<?php echo $row['category_id'] ?>">Edit</a> || <a href="delete-category.php?idc=<?php echo $row['category_id'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?')">Hapus</a>
                            </td>
                        </tr>
                        <?php }}else { ?>
                            <tr>
